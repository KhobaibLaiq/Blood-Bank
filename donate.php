...
//input password check
       ...
       //input emailcheck
        ...
        if (isset($name) && isset($blood_group) && isset($gender) && isset($day) && isset($email) && isset($contact_no) && isset($city) && isset($password)) {
           
            //encryption
            $password=  md5($password);
            $sql = "INSERT INTO donor (name,blood_group,gender,email,city,dob,contact_no,save_life_date,password,delete_status) VALUES ('$name','$blood_group','$gender','$email','$city','$day','$contact_no','0','$password','0')";
...
//        
        ...
        $termError = '<div class="alert alert-danger alert-dismissible" role="alert">
                     <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="row">
                ...
                <div class="container">
                    <div class="col-md-6 offset-md-3 form-container">
                        <h3>SignUp</h3>
                        <a href="signin.php" class="text-center">Click Here! If You Already Register.</a>
                        ...
                        <form class="form-group" action="" method="post" novalidate="" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="c_password" value="" placeholder="Confirm Password" class="form-control" required pattern=".{6,}" title="please type correct password.">
                            </div><!--End form-group-->
                            <?php if (isset($passwordError)) echo $passwordError; ?>
                            <div class="form-inline">
                                <input type="checkbox" name="term" value="true" required style="margin-left:10px;" checked>
                                <span style="margin-left:10px; color: black;"><b>I am agree to donate my blood and show my Name, Contact Nos. and E-Mail in Blood donors List</b></span>
                            </div><!--End form-group-->
